...
df["Grupo Edad"]=pd.cut(df["Edad"], bins=[0, 25, 35, 45, 50], labels=["18-25", "26-35", "36-45", "46-50"])

#feature selection
df_final = pd.concat([df.drop(columns=['ID', 'Genero', 'Suscripcion de Newsletter', 'Ingreso Mensual']), df_encoded], axis=1)
